# Generated by Django 3.2.20 on 2023-08-20 15:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateTimeField(auto_now=True, verbose_name='Artist created date')),
            ],
            options={
                'verbose_name': 'Artist',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('song', models.FileField(help_text='.wav supported only', upload_to='music/', verbose_name='Song')),
                ...
                ('album', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='songs.album', verbose_name='Song Album')),
            ],
            options={
                'verbose_name': 'Song',
        ...
        migrations.AddField(
            model_name='album',
            name='artist',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='songs.artist', verbose_name='Artist Album'),
        ),
    ]
